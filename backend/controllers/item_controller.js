...
export async function addFoodItem(req, res, newItem, estab_id) {
  try {
...
export async function deleteFoodItem(req, res, item_id) {
  try {
    const result = await pool.query(
...
export async function searchFoodItem(req, res, item_name) {
  try {
    const result = await pool.query(
...
export async function updateFoodItem(req, res, item_update) {
  try {
    const result = await pool.query(
